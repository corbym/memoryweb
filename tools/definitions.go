		...
		},
		{
			...
			InputSchema: InputSchema{
				...
				Properties: map[string]Property{
					...
					"node_kind": {Type: "string", Description: "Optional filter by node_kind. Space-separated for OR match. Applies to all three modes."},
