...
| `MEMORYWEB_DREAM_BIN` | `memoryweb` | Path to the memoryweb binary. Defaults to whatever is on `$PATH`. If absent, the digest is omitted but the hook still blocks normally. |
